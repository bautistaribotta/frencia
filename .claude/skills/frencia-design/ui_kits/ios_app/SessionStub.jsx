...
function SessionStub({ onDone }) {
  const { Button, Badge } = window.FrenciaDesignSystem_377129;
        ...
        <div style={{
          ...
          <div style={{ padding: '26px 24px 20px', textAlign: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, marginBottom: 14 }}>
              <span style={{ fontFamily: 'var(--font-display)', fontSize: 18, letterSpacing: 1, color: 'var(--text-primary)', textTransform: 'uppercase' }}>FRENCIA</span>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-around', padding: '4px 24px 22px', gap: 12 }}>
            <div style={{ textAlign: 'center' }}>
              ...
              <span className="frencia-label" style={{ fontSize: 9 }}>Duración</span>
            </div>
