function HomeScreen({ onStart }) {
  const { Avatar, Badge, Card, Button, StatTile, ProgressBar, Tag, MetricPill } = window.FrenciaDesignSystem_377129;
    ...
    <div style={{ padding: '56px 20px 120px', display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <Card variant="elevated" style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            <span className="frencia-label">Sesión de hoy</span>
      ...
      {/* Quick stats */}
      <div>
        <span className="frencia-label" style={{ display: 'block', marginBottom: 10 }}>Esta semana</span>
