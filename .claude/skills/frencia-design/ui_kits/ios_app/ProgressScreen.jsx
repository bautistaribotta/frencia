function ProgressScreen() {
  const { Card, StatTile, SegmentedControl, Badge, Tag } = window.FrenciaDesignSystem_377129;
  ...
  return (
    <div style={{ padding: '56px 20px 120px', display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div>
        <span className="frencia-label">Progreso</span>
      ...
      {/* PR history */}
      <div>
        <span className="frencia-label" style={{ display: 'block', marginBottom: 10 }}>Historial de récords</span>
          ...
          {p.prs.map((r, i) => (
            <div key={i} style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <span className="frencia-label" style={{ marginTop: 2 }}>{r.date} · est. {r.est} kg</span>
              </div>
